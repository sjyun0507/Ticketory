...
import com.gudrhs8304.ticketory.feature.story.domain.Bookmark;
...
public interface BookmarkRepository extends JpaRepository<Bookmark, Long> {
     ...
     */
    @Query("""
select new com.gudrhs8304.ticketory.feature.story.dto.response.BookmarkedStoryItemDTO(
   s.storyId,
   mv.movieId,
   mv.title,
   coalesce(
      (
         select mm.url
           from com.gudrhs8304.ticketory.feature.movie.domain.MovieMedia mm
          where mm.movie = mv
            and mm.movieMediaType = com.gudrhs8304.ticketory.feature.movie.enums.MovieMediaType.POSTER
            and mm.mediaId = (
                select min(mm2.mediaId)
                  from com.gudrhs8304.ticketory.feature.movie.domain.MovieMedia mm2
                 where mm2.movie = mv
                   and mm2.movieMediaType = com.gudrhs8304.ticketory.feature.movie.enums.MovieMediaType.POSTER
            )
      ),
      mv.posterUrl
   ),
...
from com.gudrhs8304.ticketory.feature.story.domain.StoryBookmark b
  join b.story s
  join s.movie mv
  left join com.gudrhs8304.ticketory.feature.story.domain.StoryLike sl2
         on sl2.story = s and sl2.member.memberId = :viewerId
where b.member.memberId = :ownerId
  and s.status = com.gudrhs8304.ticketory.feature.story.enums.StoryStatus.ACTIVE
