...
public interface StoryRepository extends JpaRepository<Story, Long>, JpaSpecificationExecutor<Story> {
    ...
    @Query(value = """
    select new com.gudrhs8304.ticketory.feature.story.dto.response.StorySimpleRes(
        s.storyId,
        mv.movieId,
        mv.title,
        mv.posterUrl,
    ...
    where s.member.memberId = :memberId
      and s.status <> com.gudrhs8304.ticketory.feature.story.enums.StoryStatus.DELETED
    ...
    @Query("""
select new com.gudrhs8304.ticketory.feature.story.dto.response.StoryFeedItemView(
  s.storyId,
  new com.gudrhs8304.ticketory.feature.story.dto.response.StoryMemberView(m.memberId, m.name, m.avatarUrl),
  new com.gudrhs8304.ticketory.feature.story.dto.response.StoryMovieView(v.movieId, v.title, v.posterUrl),
  s.content,
  s.rating,
...
where s.status = com.gudrhs8304.ticketory.feature.story.enums.StoryStatus.ACTIVE
group by
